package br.gesad.dragonflysimulator.view.drone;


import br.gesad.dragonflysimulator.controller.CellController;
...
import br.gesad.dragonflysimulator.util.SelectHelper;
import br.gesad.dragonflysimulator.util.WrapperHelper;
import br.gesad.dragonflysimulator.view.CellView;
import br.gesad.dragonflysimulator.view.EnvironmentView;
...
public class DroneViewImpl extends DroneView {
    ...
    ImageView imageViewBadConnection = new ImageView(new Image(getClass().getResource(ProjectPathConstant.ICON_PATH+"lostConnection.png").toString()));

    ImageView imageViewDrone = new ImageView(new Image(getClass().getResource(ProjectPathConstant.ICON_PATH+"notSelectedDrone.png").toString()));

    ImageView imageViewLostDrone = new ImageView(new Image(getClass().getResource(ProjectPathConstant.ICON_PATH+"lostDrone.png").toString()));
    ...
    public void applyStyleStarted() {
        ...
        imageViewDrone.setImage(new Image(getClass().getResource(ProjectPathConstant.ICON_PATH+"selectedDrone.png").toString()));
    }

    @Override

    public void applyStyleShutDown() {
        imageViewDrone.setImage(new Image(getClass().getResource(ProjectPathConstant.ICON_PATH+"notSelectedDrone.png").toString()));
    }
