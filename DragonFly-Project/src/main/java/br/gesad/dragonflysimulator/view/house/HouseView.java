package br.gesad.dragonflysimulator.view.house;
...
import br.gesad.dragonflysimulator.model.entity.House;
...
public class HouseView  extends Group implements SelectableView, House.Listener {
    ...
    public HouseView(String uniqueID, String houselLabel, CellView cellViewSelected) {
        ...
        Image image = new Image(getClass().getResource(ProjectPathConstant.ICON_PATH+"house.png").toString());
