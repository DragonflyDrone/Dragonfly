package br.gesad.dragonflysimulator.view.boat;
...
public class BoatView  extends Group implements SelectableView, Boat.Listener {
    ...
    public BoatView(String uniqueID, String boatLabel, CellView currentCellView) {
        ...
        Image image = new Image(getClass().getResource(ProjectPathConstant.ICON_PATH+"boat.png").toString());
        boatImageView.setImage(image);


        boxImageView = new ImageView();
        image = new Image(getClass().getResource(ProjectPathConstant.ICON_PATH+"box.png").toString());
