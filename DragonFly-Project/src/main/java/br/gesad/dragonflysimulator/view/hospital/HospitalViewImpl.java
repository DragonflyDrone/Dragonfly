package br.gesad.dragonflysimulator.view.hospital;
...
import br.gesad.dragonflysimulator.model.entity.Hospital;
...
public class HospitalViewImpl extends HospitalView {
    ...
    public HospitalViewImpl(String uniqueID, String hospitalLabel, CellView cellViewSelected) {
        ...
        Image image = new Image(getClass().getResource(ProjectPathConstant.ICON_PATH+"hospital.png").toString());
