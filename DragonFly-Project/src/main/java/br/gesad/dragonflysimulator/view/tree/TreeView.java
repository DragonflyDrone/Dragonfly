package br.gesad.dragonflysimulator.view.tree;
...
import br.gesad.dragonflysimulator.model.entity.Tree;
...
public class TreeView extends Group implements SelectableView, Tree.Listener {
    ...
    public TreeView(String uniqueID, String treelLabel, CellView cellViewSelected) {
        ...
        Image image = new Image(getClass().getResource(ProjectPathConstant.ICON_PATH+"tree.png").toString());
