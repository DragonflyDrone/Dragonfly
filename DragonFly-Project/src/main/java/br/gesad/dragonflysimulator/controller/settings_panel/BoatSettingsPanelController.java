package br.gesad.dragonflysimulator.controller.settings_panel;

import br.gesad.dragonflysimulator.MainController;
...
public class BoatSettingsPanelController extends SettingsPanelController<Boat> {
    ...
    private BoatSettingsPanelController(AnchorPane defaultPanelSettingsAnchorPane) {
        ...
        loader.setLocation(getClass().getResource(ProjectPathConstant.FXML_PATH+"boat_settings_panel.fxml"));
