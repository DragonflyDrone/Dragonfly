...
import br.gesad.dragonflysimulator.controller.BoatAutomaticController;
...
import br.gesad.dragonflysimulator.model.Cell;
...
import br.gesad.dragonflysimulator.util.AStarAlgorithm;
...
public aspect NoneBoatWrapper {
    ...
    pointcut consumeReset() : call( void br.gesad.dragonfly.controller.BoatAutomaticController.consumeReset());
