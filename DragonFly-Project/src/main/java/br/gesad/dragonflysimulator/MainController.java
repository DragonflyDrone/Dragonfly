...
import br.gesad.dragonflysimulator.controller.settings_panel.BoatSettingsPanelController;
import br.gesad.dragonflysimulator.controller.settings_panel.DroneSettingsPanelController;
...
import br.gesad.dragonflysimulator.model.entity.*;
...
import br.gesad.dragonflysimulator.view.antenna.AntennaView;
import br.gesad.dragonflysimulator.view.boat.BoatView;
import br.gesad.dragonflysimulator.view.drone.DroneView;
import br.gesad.dragonflysimulator.view.hospital.HospitalView;
import br.gesad.dragonflysimulator.view.house.HouseView;
...
public class MainController extends Application {
    ...
    public void start(Stage primaryStage) throws Exception {
        ...
        loader.setLocation(getClass().getResource(ProjectPathConstant.FXML_PATH+"main_panes.fxml"));
    ...
    private void initialize() {
        ...
        //init type of drone br.gesad.dragonfly.controller
...
*/
        ...
        deleteButton.setOnAction(event -> {
            ...
            Alert alert = new Alert(Alert.AlertType.CONFIRMATION, "Are you sure you want to delete this br.gesad.dragonfly.view?", ButtonType.YES ,ButtonType.CANCEL);
            alert.showAndWait();
