...
public class Cyclist extends Entity {
    ...
    public static  int COUNT_CYCLIST = 1;
    ...
    public Cyclist(String uniqueID, String label, Cell sourceCell) {
    ...
    public static int getCountCyclist() {
        return COUNT_CYCLIST;
    }

    public static void setCountCyclist(int countCyclist) {
        COUNT_CYCLIST = countCyclist;
    }
    ...
    private void notifiesListeners(String attributeName, Object oldValue, Object newValue){
        ...
        synchronized (this){
            for (Cyclist.Listener listener : listeners){
