...
public class Biker extends Entity {

    public static  int COUNT_BIKER = 1;
    ...
    public Biker(String uniqueID, String label, Cell sourceCell) {
    ...
    public interface Listener {
        public void onChange(Biker cyclist, String methodName, Object oldValue, Object newValue);
    }

    public static int getCountBiker() {
        return COUNT_BIKER;
    }

    public static void setCountBiker(int countBiker) {
        COUNT_BIKER = countBiker;
    }
    ...
    private void notifiesListeners(String attributeName, Object oldValue, Object newValue){
        ...
        synchronized (this){
            for (Biker.Listener listener : listeners){
