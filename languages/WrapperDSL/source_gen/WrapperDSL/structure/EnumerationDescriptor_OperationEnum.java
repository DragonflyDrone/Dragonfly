...
public class EnumerationDescriptor_OperationEnum extends EnumerationDescriptorBase {
  ...
  private final EnumerationDescriptor.MemberDescriptor myMember_not_equal_to_0 = new EnumerationDescriptor.MemberDescriptor("not_equal_to", "not equal to", 0x53be3ecc045a8c43L, "r:791815a7-51ee-4ec9-bcc3-2de9ba0316d3(WrapperDSL.structure)/6034329596690336835");
  private final EnumerationDescriptor.MemberDescriptor myMember_less_than_0 = new EnumerationDescriptor.MemberDescriptor("less_than", "less than", 0x53be3ecc045a8c46L, "r:791815a7-51ee-4ec9-bcc3-2de9ba0316d3(WrapperDSL.structure)/6034329596690336838");
  private final EnumerationDescriptor.MemberDescriptor myMember_greater_than_0 = new EnumerationDescriptor.MemberDescriptor("greater_than", "greater than", 0x53be3ecc045a8c4aL, "r:791815a7-51ee-4ec9-bcc3-2de9ba0316d3(WrapperDSL.structure)/6034329596690336842");
  private final EnumerationDescriptor.MemberDescriptor myMember_less_than_or_equal_to_0 = new EnumerationDescriptor.MemberDescriptor("less_than_or_equal_to", "less than or equal to", 0x53be3ecc045a8c55L, "r:791815a7-51ee-4ec9-bcc3-2de9ba0316d3(WrapperDSL.structure)/6034329596690336853");
  private final EnumerationDescriptor.MemberDescriptor myMember_greater_than_or_equal_to_0 = new EnumerationDescriptor.MemberDescriptor("greater_than_or_equal_to", "greater than or equal to", 0x53be3ecc045a8c4fL, "r:791815a7-51ee-4ec9-bcc3-2de9ba0316d3(WrapperDSL.structure)/6034329596690336847");
