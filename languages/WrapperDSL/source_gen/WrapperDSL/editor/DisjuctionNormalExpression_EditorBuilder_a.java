...
/*package*/ class DisjuctionNormalExpression_EditorBuilder_a extends AbstractEditorBuilder {
  @NotNull
  private SNode myNode;

  public DisjuctionNormalExpression_EditorBuilder_a(@NotNull EditorContext context, @NotNull SNode node) {
    super(context);
    myNode = node;
  }
  ...
  private EditorCell createCollection_0() {
    ...
    editorCell.setCellId("Collection_d0fgev_a");
  ...
  private EditorCell createConstant_0() {
    ...
    editorCell.setCellId("Constant_d0fgev_a0");
    editorCell.setDefaultText("");
    return editorCell;
  }
  private EditorCell createRefNode_0() {
    SingleRoleCellProvider provider = new leftSingleRoleHandler_d0fgev_b0(myNode, LINKS.left$BwFB, getEditorContext());
    return provider.createCell();
  }
  private static class leftSingleRoleHandler_d0fgev_b0 extends SingleRoleCellProvider {
    @NotNull
    private SNode myNode;

    public leftSingleRoleHandler_d0fgev_b0(SNode ownerNode, SContainmentLink containmentLink, EditorContext context) {
  ...
  private EditorCell createRefNode_1() {
    SingleRoleCellProvider provider = new rightSingleRoleHandler_d0fgev_d0(myNode, LINKS.right$BwED, getEditorContext());
    return provider.createCell();
  }
  private static class rightSingleRoleHandler_d0fgev_d0 extends SingleRoleCellProvider {
    @NotNull
    private SNode myNode;

    public rightSingleRoleHandler_d0fgev_d0(SNode ownerNode, SContainmentLink containmentLink, EditorContext context) {
      super(containmentLink, context);
      myNode = ownerNode;
    }
  ...
  private EditorCell createConstant_1() {
    EditorCell_Constant editorCell = new EditorCell_Constant(getEditorContext(), myNode, ")");
    editorCell.setCellId("Constant_d0fgev_e0");
    editorCell.setDefaultText("");
    return editorCell;
  }
