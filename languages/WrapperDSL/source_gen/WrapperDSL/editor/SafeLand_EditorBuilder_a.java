...
/*package*/ class SafeLand_EditorBuilder_a extends AbstractEditorBuilder {
  @NotNull
  private SNode myNode;

  public SafeLand_EditorBuilder_a(@NotNull EditorContext context, @NotNull SNode node) {
    super(context);
    myNode = node;
  }
  ...
  private EditorCell createCollection_0() {
    ...
    editorCell.setCellId("Collection_xmsqpm_a");
  ...
  private EditorCell createProperty_0() {
    ...
    try {
      final SProperty property = PROPS.value$8reH;
  ...
  private EditorCell createConstant_0() {
    EditorCell_Constant editorCell = new EditorCell_Constant(getEditorContext(), myNode, "safe land");
    editorCell.setCellId("Constant_xmsqpm_b0");
