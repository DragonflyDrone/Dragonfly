...
SET BITS=64
SET USER_JDK64_FILE=%USERPROFILE%\.DSL-Dragonfly1.0\config\dsl-dragonfly%BITS%.exe.jdk
SET BITS=
SET USER_JDK_FILE=%USERPROFILE%\.DSL-Dragonfly1.0\config\dsl-dragonfly%BITS%.exe.jdk
...
IF NOT EXIST "%VM_OPTIONS_FILE%" (
  :: user-overridden
  SET VM_OPTIONS_FILE=%USERPROFILE%\.DSL-Dragonfly1.0\config\mps%BITS%.exe.vmoptions
)
IF NOT EXIST "%VM_OPTIONS_FILE%" (
